                ...
                <form method="post" action="./updatePro.php">
                    ...
                    <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input class="form-control" type="text" onkeyup="passwordCheckFunction();" id="userPassword1" name="userPassword1" maxLength="20" placeholder="비밀번호를 입력해주세요." value="<?=$row['passwd']?>" required></td>
                        </tr>
                        <tr>
